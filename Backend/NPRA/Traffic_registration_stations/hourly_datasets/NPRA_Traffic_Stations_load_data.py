...
COORDINATES_STAVANGER_FILE_NAME = 'Stavanger/hourly_level_1_STAVANGER.csv'
COORDINATES_BERGEN_FILE_NAME = 'Bergen/hourly_level_1_BERGEN.csv'
COORDINATES_OSLO_FILE_NAME = 'Oslo/hourly_level_1_OSLO.csv'
