...
Figure \ref{fig:Conceptual_o} show the conceptual oversights of what this program hopes to be structured like. First the sources are collected and converted into a more convenient format to work with, that format is stored and then analysed, and lastly the results are presented visually.

\begin{figure}[h]
\includegraphics[width=8cm]{conseptual_overall}
\centering
...
\begin{figure}[!htb]
\includegraphics[width=16cm]{backend_diagram}
\centering
...
\begin{figure}[h]
\includegraphics[width=16cm]{frontend_diagram}
\centering
