...
def NPRA_seasons_weekly(year_start, year_end, city='Norway'):
...
def kolumbus_seasons_weekly(year_start, year_end): # accepts season [15_16, 16_17]
...
def ruter_seasons_weekly(year_start, year_end): # accepts season [15_16, 16_17, 17_18]
...
def double_y_graph(y1, y2, color1='#4286f4', color2='#872323'): # assumes common x-axis of 52 units (weeks)
...
def main():
    NIPH_virus_Y = NIPH_virus_detections.NIPH_Virus().get_season_17_18() # [15_16, 16_17, 17_18]
    #for _ in range(len(NIPH_virus_Y), 52): NIPH_virus_Y.append(None) # all graphs must have 52 units (weeks) on the x axis
    NIPH_ILI_Y = NIPH_ILS_graf.NIPH_ILI('../Backend/NIPH/ILI_tall_2016_17.xlsx').get_season_16_17() # [16_17]
    for _ in range(len(NIPH_ILI_Y), 52): NIPH_ILI_Y.append(None) # all graphs must have 52 units (weeks) on the x axis
    
    #double_y_graph(NIPH_ILI_Y, NPRA_seasons_weekly(2015, 2016, 'oSLo'))
    #double_y_graph(NIPH_ILI_Y, twitter_seasons_weekly())
    #double_y_graph(NIPH_ILI_Y, kolumbus_seasons_weekly(2015, 2016))
    double_y_graph(NIPH_virus_Y, ruter_seasons_weekly(2017, 2018))
